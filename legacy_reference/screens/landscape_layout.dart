    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Stack(children: [
          const TopBar(),
          const DrawingComponentsTreeBox(),
          const DrawingBoardBackgroundBox(),
          const EditFeaturesPalleteBox(),
          const AnimationSheetWidget(),
          if(showLibrary)const LibrarySamples()
          // Positioned(
          //     left: 250,
          //     top: 150,
